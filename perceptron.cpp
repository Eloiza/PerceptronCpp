...
class Perceptron{
    private:
        ...
        short int theta;
    public:
        void fit(std::array<int, 5> x, short int y, short int label);
        short int predict(std::array<int, 5> x);

        std::array<int, 5> get_weights();
};
# 2 "main.cpp" 2
...
int main(){
    ...
    std::array<int, 5> w = p.get_weights();
